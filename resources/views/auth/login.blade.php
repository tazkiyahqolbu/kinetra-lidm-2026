...
<div class="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 to-emerald-50 pt-20 pb-20">
    <div class="w-full max-w-md">
        ...
        <div class="bg-white rounded-2xl shadow-2xl p-8">
            ...
            <!-- Social Login -->
            <button class="w-full flex items-center justify-center space-x-2 border-2 border-gray-200 text-gray-700 font-semibold py-3 rounded-lg hover:bg-gray-50 transition">
